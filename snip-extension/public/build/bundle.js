...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 11, 13, 213);
    			add_location(button, file, 12, 2, 256);
    			attr_dev(main, "class", "svelte-dic9ip");
    			add_location(main, file, 10, 0, 193);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*image*/ ctx[0]);
    			append_dev(main, t1);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", change, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*image*/ 1 && input.value !== /*image*/ ctx[0]) {
    				set_input_value(input, /*image*/ ctx[0]);
    			}
    		},
    		i: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ browser: browserPolyfill, image, change });
    	...
    	return [image, input_input_handler];
    }
